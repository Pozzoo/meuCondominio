...
export function Welcome() {
  return (
    <main className="h-full flex justify-center p-2.5" style={{backgroundImage: `url(${Background})`}}>
      <div className="flex-1 flex flex-col items-center justify-between gap-16 min-h-0 backdrop-blur-[1.5px]">
        <header className="w-full flex items-start justify-between gap-9">
          <AshGrayContainer className="justify-center items-center">
            <LogoComponent/>
          </AshGrayContainer>
        ...
        <div className="flex justify-around w-2/3 px-4">
          <AshGrayContainer className="max-w-[650px] max-h-[250px] justify-center items-center">
          ...
          <AshGrayContainer className="max-w-[350px] h-[400px] justify-start items-start text-xl">
        ...
        <div>
          <AshGrayContainer className="mb-5">
